...
The Prain assets are original vector emblazonments based on the published description for Lt-Col Sir David Prain:

- Arms: Argent semé of lotus flowers Azure and roses Gules, the latter barbed and seeded Vert; on a chief Gules three weavers' shuttles Argent.
...
`heritage/rook.svg` is a narrative surname motif, not a family coat of arms.

## Usage caveat

Institutional names, badges and logos may be protected by brand or trade-mark rules. These files deliberately provide original heraldic/motif renderings for subtle alumni / heritage references rather than pretending to be official institutional logo assets. Possession of a vector rendering of historical arms does not establish a legal entitlement to bear those arms.
